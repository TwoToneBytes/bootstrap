            ...
            link: function (scope, element, attrs, ctrls) {
                ...
                function refill(updateSelected) {
                    ...
                    if (ngModel.$modelValue) {
                        ...
                        // Date(0) is a placeholder for 'now' no matter the actual point in time
                        if (+date === 0) {
                            // so set
                            date = new Date();
                        }
            ...
            return {
                ...
                link: function (originalScope, element, attrs, ngModel) {
                    ...
                    function updatePosition() {
                        ...
                        scope.position.top = scope.position.top + element.prop('offsetHeight') + element.attr('datepickerPushDown');
                        scope.position.left = scope.position.left + element.attr('datepickerPushLeft');
                    }
